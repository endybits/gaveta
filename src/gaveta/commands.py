...
# Stage 2 implements four of the ten. They dispatch; they are no longer reserved
# words that exit 2. The set is a frozenset because membership is all the CLI asks.
IMPLEMENTED: frozenset[str] = frozenset({"ls", "show", "rm", "export"})
